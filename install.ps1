...
Write-Host "[*] Installing FEDERaiDE with extras (audio, vision) on standardized Python 3.12..." -ForegroundColor Yellow
uv tool install --force --refresh --python 3.12 "federaide[audio,vision]"
